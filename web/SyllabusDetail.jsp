...
<html>
    ...
    <body>
        ...
        <jsp:include page="view/navigation/header1.jsp"/>
            ...
            <div style="display: flex; justify-content: center">
                <form action="SyllabusDetail" method="get" style="padding: 5px; width: 95%">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>Table concern Syllabus</td>
                            <td>
                              
                                <c:if test="${sessionScope.roleName == 'staff_of_crdd' or sessionScope.roleName == 'admin' or sessionScope.roleName == 'guest' or sessionScope.roleName == 'Teacher' or sessionScope.roleName == 'syllabus_reviewer' or sessionScope.roleName == 'student' or sessionScope.roleName == 'head_of_crdd' or sessionScope.roleName == 'syllabus_designer'}">

                                    <button type="button" class="btn btn-light">
                                        <a href="listMaterial?sid=${s.sID}&search=-2">
                                            Material
                                        </a>
                                    </c:if>
                                </button>
                                <c:if test="${sessionScope.roleName == 'staff_of_crdd' or sessionScope.roleName == 'admin' or sessionScope.roleName == 'guest' or sessionScope.roleName == 'Teacher' or sessionScope.roleName == 'syllabus_reviewer' or sessionScope.roleName == 'student' or sessionScope.roleName == 'head_of_crdd' or sessionScope.roleName == 'syllabus_designer'}">
                                    <button type="button" class="btn btn-light">
                                        <a href="listAssessment?sid=${s.sID}&search=-2">
                                            Assessment
                                        </a>
                                    </button>
                                </c:if>
                                <c:if test="${sessionScope.roleName == 'staff_of_crdd' or sessionScope.roleName == 'admin' or sessionScope.roleName == 'Teacher' or sessionScope.roleName == 'syllabus_reviewer' or sessionScope.roleName == 'student' or sessionScope.roleName == 'head_of_crdd' or sessionScope.roleName == 'syllabus_designer'}">


                                    <button type="button" class="btn btn-light">
                                        <a href="listSession?sid=${s.sID}&search=-2">
                                            Session
                                        </a>
                                    </button>
                                </c:if>
                    ...
                    <div style="width: 95%; margin-left: 3rem">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-PO-tab" data-toggle="tab" href="#nav-PO" role="tab" aria-controls="nav-PO" aria-selected="true">PO</a>
        ...
        <%--<c:if test="${sessionScope.roleName != 'guest' && sessionScope.roleName != null}">--%>
            <a class="nav-item nav-link" id="nav-session-tab" data-toggle="tab" href="#nav-session" role="tab" aria-controls="nav-session" aria-selected="false">Session</a>
        <%--</c:if>--%>
...
<div class="tab-content" id="nav-tabContent">
    ...
    <div class="tab-pane fade" id="nav-material" role="tabpanel" aria-labelledby="nav-material-tab">
        ...
        <%--<jsp:include page="view/Material/MaterialListUserSyllabus.jsp"/>--%>
    </div>
        <%--<c:if test="${sessionScope.roleName != 'guest' && sessionScope.roleName != null}">--%>
            <div class="tab-pane fade" id="nav-session" role="tabpanel" aria-labelledby="nav-session-tab">

        <%--<jsp:include page="view/Session/SessionListUserSyllabus.jsp"/>--%>
        <%--<jsp:include page="view/session/SessionListUserSyllabus.jsp"/>--%>
    </div>
        <%--</c:if>--%>
        ...
        <%--<jsp:include page="view/Session/SessionListUserSyllabus.jsp"/>--%>
        <jsp:include page="view/assessment/AssessmentListUserSyllabus.jsp"/>
    </div>
</div>
</div>
</div>-->
