...
<html>
    ...
    <body>
        <%--<c:set var = "u" scope = "session" value = "${u}"/>--%>
                    ...
                    <div class="card p-3">
                        <div class="e-navlist e-navlist--active-bg">
                            <ul class="nav">
                                ...
                                <li class="nav-item"><a class="nav-link px-2" href="EditProfile" target="__blank" href="edit_profile.jsp"><i class="fa fa-fw fa-cog mr-1"></i><span>Edit Profile</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control" type="text" name="name" placeholder="${u.uname}" value="" readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <label>Email</label>
                                                                        <input class="form-control" type="text" name="username" placeholder="${u.uemail}" value="" readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control" type="text" placeholder="Phone number" value="${u.umobile}" readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col mb-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea class="form-control" rows="5" placeholder="Description" readonly>description is in beta, please ignore this section</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
