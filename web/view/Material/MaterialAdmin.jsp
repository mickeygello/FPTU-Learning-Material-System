    ...
    <body>
        ...
        <section id="content">
            ...
            <nav>
                ...
                <a href="index." class="nav-link"><img style="width:40%;" src="assets/images/logo_fpt.png" alt="image logo"></a>
                <form action="#">
            ...
            <main>
                <div class="head-title">
                    <div class="left">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a class="active" href="jsp.jsp">Home</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <jsp:include page="MaterialDetail.jsp"/>
