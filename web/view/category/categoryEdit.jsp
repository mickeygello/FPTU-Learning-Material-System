        ...
        <section id="content">
            ...
            <main>
                ...
                <div class="formCrud">
                         ...
                         <form action="editCategory" method="post" style="padding: 5px; width: 100%; ">
                        <c:set var="c" value ="${requestScope.category}"/>
                        <div style="display:flex; justify-content: space-between; margin-top: 20px">
                            <div class="inputSize">
                                <label style="font-weight: bold">Category Name:</label>
                                <input style="" placeholder="Input Category Name" type="text" name="name" value="${c.categoryName}" class="form-control">
                            </div>
